...
public class Client extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Users online", jPanel1);
        ...
        jLabel1.setText("Choose recive user");

        jLabel2.setText("Enter a message");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("{Receivers}");
        ...
        jTabbedPane1.addTab("Texting", jPanel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(messageContent.isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "You haven't entered message");
            return;
        }
        if(jComboBox1.getSelectedIndex()==0){
            try {
                ...
                JOptionPane.showMessageDialog(rootPane, "There was an error");
            }
        }else{
            try {
                String[] parner = ((String)jComboBox1.getSelectedItem()).split(" ");
                write("send-to-person"+","+messageContent+","+this.id+","+parner[1]);
                jTextArea1.setText(jTextArea1.getText()+"You (to Client "+parner[1]+"): "+messageContent+"\n");
                jTextArea1.setCaretPosition(jTextArea1.getDocument().getLength());
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(rootPane, "There was an error");
            }
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        if(jComboBox1.getSelectedIndex()==0){
            ...
            jLabel3.setText("In chatting with "+jComboBox1.getSelectedItem());
        }
                        ...
                        while (true) {
                            ...
                            if (messageSplit[0].equals("update-online-list")) {
                                ...
                                for(int i=0; i<onlineSplit.length; i++){
                                    ...
                                    online+="Client "+onlineSplit[i]+" is online\n";
                                }
...
//                    socketOfClient.close();
    ...
    private void updateCombobox(){
        ...
        jComboBox1.addItem("Send to all users");
